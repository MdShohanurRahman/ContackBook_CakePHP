...
<div class="card">
  ...
  <div class="card-body">
            ...
            <fieldset>
                ...
                <?php
                    echo $this->Form->control('title',['class'=>'form-control mb-2','label'=>'Contact Name','required' => true]);
                    echo $this->Form->control('image_file',['type'=>'file','class'=>'form-control border-0 mb-2','label'=>'Image']);
                    echo $this->Form->control('groups._ids', ['options' => $groups,'class'=>'form-control','label'=>'Contact Group','required' => true]);
                ?>
            </fieldset>
...
<h4 class="my-3">Contact details</h4>
    <div class="form-row mx-2">
      ...
      <div class="col">
        <input type="tel" class="form-control" id="mobile" name="details[0][mobile]" placeholder="Mobile" required>
      </div>
      <div class="col">
      
        <input type="tel" class="form-control" id="phone" placeholder="Phone" name=" details[0][phone]" required>
      </div>
      <div class="col">
